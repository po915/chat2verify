                ...
                <div class="mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Navigation Links -->
                            <navigation class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex"></navigation>
                        </div>
                            ...
                            <jet-dropdown align="right" width="60">
                              <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                ...
                                                {{
                                                $page.props.user.current_phone_number && $page.props.user.current_phone_number.friendly_name || 'Phone numbers'
                                              }}
                              ...
                              <template #content>
                                <div class="w-60">
                                  ...
                                  <!-- Team Management -->
                                  <template v-for="number in $page.props.user.current_team.phone_numbers"
                                            :key="number.id">
                                    <form @submit.prevent="switchToPhoneNumber(number)">
                                      <jet-dropdown-link as="button">
                                        <div class="flex items-center">
                                          <svg
                                              v-if="number.id == $page.props.user.current_phone_number_id"
    ...
    export default {
        ...
        methods: {
          ...
          switchToPhoneNumber(number) {
            this.$inertia.put(route('current-phone-number.update'), {
