<template>
    <div>
        <jet-label class="mb-1">Country</jet-label>
        <multiselect mode="single" valueProp="code" trackBy="name" label="name" ref="input" :options="countries" v-bind="$attrs"></multiselect>
    </div>
</template>
